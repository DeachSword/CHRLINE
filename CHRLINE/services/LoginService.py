...
class LoginService(object):
    ...
    def qrCodeLoginForSecure(self):
        ...
        params = []
        sqrd = self.generateDummyProtocol(METHOD_NAME, params, self.LoginService_REQ_TYPE)
        return self.postPackDataAndGetUnpackRespData(self.LoginService_API_PATH ,sqrd,  self.LoginService_RES_TYPE)
    ...
    def qrCodeLoginV2ForSecure(self):
        ...
        DATETIME: 10/31/2022, 08:17:56
        """
        raise Exception("qrCodeLoginV2ForSecure is not implemented")
    ...
    def createQrCodeForSecure(self):
        ...
        DATETIME: 10/31/2022, 08:17:56
        """
        raise Exception("createQrCodeForSecure is not implemented")
