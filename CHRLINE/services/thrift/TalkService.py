...
class Iface(object):
    ...
    def getChatRoomAnnouncementsBulk(self):
        pass

    def getChatRoomAnnouncements(self):
        pass

    def removeChatRoomAnnouncement(self):
        pass
...
class Client(Iface):
    ...
    def getChatRoomAnnouncementsBulk(self):
        self.send_getChatRoomAnnouncementsBulk()
        return self.recv_getChatRoomAnnouncementsBulk()

    def send_getChatRoomAnnouncementsBulk(self):
    ...
    def getChatRoomAnnouncements(self):
        self.send_getChatRoomAnnouncements()
        return self.recv_getChatRoomAnnouncements()

    def send_getChatRoomAnnouncements(self):
    ...
    def removeChatRoomAnnouncement(self):
        self.send_removeChatRoomAnnouncement()
        self.recv_removeChatRoomAnnouncement()

    def send_removeChatRoomAnnouncement(self):
    ...
    def createChatRoomAnnouncement(self):
        self.send_createChatRoomAnnouncement()
        return self.recv_createChatRoomAnnouncement()

    def send_createChatRoomAnnouncement(self):
...
class Processor(Iface, TProcessor):
    ...
    def process_getChatRoomAnnouncementsBulk(self, seqid, iprot, oprot):
        ...
        result = getChatRoomAnnouncementsBulk_result()
        try:
            result.success = self._handler.getChatRoomAnnouncementsBulk()
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TalkException as e:
    ...
    def process_getChatRoomAnnouncements(self, seqid, iprot, oprot):
        ...
        result = getChatRoomAnnouncements_result()
        try:
            result.success = self._handler.getChatRoomAnnouncements()
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TalkException as e:
    ...
    def process_removeChatRoomAnnouncement(self, seqid, iprot, oprot):
        ...
        result = removeChatRoomAnnouncement_result()
        try:
            self._handler.removeChatRoomAnnouncement()
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TalkException as e:
    ...
    def process_createChatRoomAnnouncement(self, seqid, iprot, oprot):
        ...
        result = createChatRoomAnnouncement_result()
        try:
            result.success = self._handler.createChatRoomAnnouncement()
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TalkException as e:
...
class findAndAddContactsByMid_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i683 in range(_size679):
                        _key684 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val685 = Contact()
                        _val685.read(iprot)
                        self.success[_key684] = _val685
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter686, viter687 in self.success.items():
...
class findAndAddContactsByPhone_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    self.phones = set()
                    (_etype691, _size688) = iprot.readSetBegin()
                    for _i692 in range(_size688):
                        _elem693 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.phones.add(_elem693)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.phones is not None:
            ...
            for iter694 in self.phones:
                oprot.writeString(iter694.encode('utf-8') if sys.version_info[0] == 2 else iter694)
            oprot.writeSetEnd()
            oprot.writeFieldEnd()
        if self.reference is not None:
...
class findAndAddContactsByPhone_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i699 in range(_size695):
                        _key700 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val701 = Contact()
                        _val701.read(iprot)
                        self.success[_key700] = _val701
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.MAP, 0)
            oprot.writeMapBegin(TType.STRING, TType.STRUCT, len(self.success))
            for kiter702, viter703 in self.success.items():
                oprot.writeString(kiter702.encode('utf-8') if sys.version_info[0] == 2 else kiter702)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i708 in range(_size704):
                        _elem709 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i722 in range(_size718):
                        _elem723 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i729 in range(_size725):
                        _key730 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val731 = Contact()
                        _val731.read(iprot)
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter732, viter733 in self.success.items():
                oprot.writeString(kiter732.encode('utf-8') if sys.version_info[0] == 2 else kiter732)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i738 in range(_size734):
                        _elem739 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
...
class syncContacts_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i745 in range(_size741):
                        _elem746 = ContactModification()
                        _elem746.read(iprot)
                        self.localContacts.append(_elem746)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.localContacts is not None:
            ...
            for iter747 in self.localContacts:
                iter747.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class syncContacts_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i752 in range(_size748):
                        _key753 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val754 = ContactRegistration()
                        _val754.read(iprot)
                        self.success[_key753] = _val754
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.MAP, 0)
            oprot.writeMapBegin(TType.STRING, TType.STRUCT, len(self.success))
            for kiter755, viter756 in self.success.items():
                oprot.writeString(kiter755.encode('utf-8') if sys.version_info[0] == 2 else kiter755)
                viter756.write(oprot)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i775 in range(_size771):
                        _key776 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val777 = Contact()
                        _val777.read(iprot)
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter778, viter779 in self.success.items():
                oprot.writeString(kiter778.encode('utf-8') if sys.version_info[0] == 2 else kiter778)
...
class getLastE2EEPublicKeys_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i784 in range(_size780):
                        _key785 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val786 = E2EEPublicKey()
                        _val786.read(iprot)
                        self.success[_key785] = _val786
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.MAP, 0)
            oprot.writeMapBegin(TType.STRING, TType.STRUCT, len(self.success))
            for kiter787, viter788 in self.success.items():
                oprot.writeString(kiter787.encode('utf-8') if sys.version_info[0] == 2 else kiter787)
                viter788.write(oprot)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
            ...
            if fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i793 in range(_size789):
                        _elem794 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.roomIds.append(_elem794)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i842 in range(_size838):
                        _key843 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val844 = []
                        (_etype848, _size845) = iprot.readListBegin()
                        for _i849 in range(_size845):
                            _elem850 = ChatRoomAnnouncement()
                            _elem850.read(iprot)
                            _val844.append(_elem850)
                        iprot.readListEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter851, viter852 in self.success.items():
                ...
                oprot.writeListBegin(TType.STRUCT, len(viter852))
                for iter853 in viter852:
                    iter853.write(oprot)
                oprot.writeListEnd()
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
