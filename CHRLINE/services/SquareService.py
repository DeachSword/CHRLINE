...
class SquareService(BaseService):
    ...
    def getJoinedSquareChatThreads(self):
        """
        AUTO_GENERATED_CODE! DONT_USE_THIS_FUNC!!
        ...
        """
        raise Exception("getJoinedSquareChatThreads is not implemented")
        METHOD_NAME = "getJoinedSquareChatThreads"
        params = []
        sqrd = self.generateDummyProtocol(METHOD_NAME, params, self.SquareService_REQ_TYPE)
        return self.postPackDataAndGetUnpackRespData(self.SquareService_API_PATH, sqrd, self.SquareService_RES_TYPE)

    def createSquareChatThread(self):
        """
        AUTO_GENERATED_CODE! DONT_USE_THIS_FUNC!!
        ...
        DATETIME: 04/24/2023, 18:07:51
        """
        raise Exception("createSquareChatThread is not implemented")
        METHOD_NAME = "createSquareChatThread"
        params = []
        sqrd = self.generateDummyProtocol(METHOD_NAME, params, self.SquareService_REQ_TYPE)
        return self.postPackDataAndGetUnpackRespData(self.SquareService_API_PATH, sqrd, self.SquareService_RES_TYPE)

    def getSquareChatThread(self):
        """
        AUTO_GENERATED_CODE! DONT_USE_THIS_FUNC!!
        ...
        DATETIME: 04/24/2023, 18:07:51
        """
        raise Exception("getSquareChatThread is not implemented")
        METHOD_NAME = "getSquareChatThread"
        params = []
        sqrd = self.generateDummyProtocol(METHOD_NAME, params, self.SquareService_REQ_TYPE)
        return self.postPackDataAndGetUnpackRespData(self.SquareService_API_PATH, sqrd, self.SquareService_RES_TYPE)

    def joinSquareChatThread(self):
        """
        AUTO_GENERATED_CODE! DONT_USE_THIS_FUNC!!
        ...
        DATETIME: 04/24/2023, 18:07:51
        """
        raise Exception("joinSquareChatThread is not implemented")
    ...
    def syncSquareMembers(self):
        ...
        DATETIME: 04/24/2023, 18:07:51
        """
        raise Exception("syncSquareMembers is not implemented")
